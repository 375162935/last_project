 ...
 * Licensed under the MIT license */
    function (t, e, n, i) {
        ...
        var wt = s(function (t, e, n) {
            ...
            _t = T(t, "PointerEvent") !== i, Ct = xt && kt.test(navigator.userAgent), bt = "touch", Mt = "pen",
        ...
        var Kt = {pointerdown: Pt, pointermove: At, pointerup: It, pointercancel: Ht, pointerout: Ht},
            Ut = {2: bt, 3: Mt, 4: Et, 5: Dt}, Bt = "pointerdown", Gt = "pointermove pointerup pointercancel";
        t.MSPointerEvent && !t.PointerEvent && (Bt = "MSPointerDown", Gt = "MSPointerMove MSPointerUp MSPointerCancel"), c(F, _, {
            handler: function (t) {
                var e = this.store, n = !1, i = t.type.toLowerCase().replace("ms", ""), a = Kt[i],
                    r = Ut[t.pointerType] || t.pointerType, o = r == bt, s = g(e, t.pointerId, "pointerId");
    ...
    "use strict";
    var e, n = function (e) {
        var n = t("<div class='weui_mask weui_actions_mask'></div>").appendTo(document.body), i = e.actions || [],
    ...
    var e, n = !1, i = function (i) {
        ...
        function s(t) {
            if (t.preventDefault(), !u.opened && (u.open(), u.params.scrollToInput && !a())) {
                ...
                if (0 === e.length) return;
                var n, i = parseInt(e.css("padding-top"), 10), r = parseInt(e.css("padding-bottom"), 10),
                    o = e[0].offsetHeight - i - u.container.height(), s = e[0].scrollHeight - i - u.container.height(),
        ...
        return u.animating = !1, u.addValue = function (t) {
            ...
            var a = u.daysInMonth(new Date(t.getFullYear(), t.getMonth()).getTime() - 864e6), r = u.daysInMonth(t),
                o = new Date(t.getFullYear(), t.getMonth()).getDay();
            0 === o && (o = 7);
            var s, c, l, p = [], h = 6, d = 7, f = "", m = 0 + (u.params.firstDay - 1),
                v = (new Date).setHours(0, 0, 0, 0), g = u.params.minDate ? new Date(u.params.minDate).getTime() : null,
            ...
            var n = parseInt(u.months.eq(u.months.length - 1).attr("data-month"), 10),
                i = parseInt(u.months.eq(u.months.length - 1).attr("data-year"), 10), a = new Date(i, n),
                r = a.getTime(), o = !u.animating;
            ...
            "undefined" != typeof e && "object" != typeof e || (e = "", u.params.animate || (e = 0));
            var n = parseInt(u.months.eq(0).attr("data-month"), 10), i = parseInt(u.months.eq(0).attr("data-year"), 10),
                a = new Date(i, n + 1, -1), r = a.getTime(), o = !u.animating;
            ...
            var a = new Date(u.currentYear, u.currentMonth).getTime(), r = i > a ? "next" : "prev",
            ...
            var t, e = "", n = "", i = u.value && u.value.length ? u.value[0] : (new Date).setHours(0, 0, 0, 0),
                a = u.monthHTML(i, "prev"), r = u.monthHTML(i), o = u.monthHTML(i, "next"),
